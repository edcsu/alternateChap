...
@Component({
  selector: 'app-chap-dist-chat-list',
  templateUrl: './chap-dist-chat-list.component.html',
  styleUrls: ['./chap-dist-chat-list.component.scss']
})

export class ChapDistChatListComponent implements OnInit {

  constructor(
                private bottomSheetRef: MatBottomSheetRef<ChapDistChatListComponent>
              ) { }
